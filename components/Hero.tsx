                        ...
                        <div className="space-y-6 max-w-xl group/bio">
                                ...
                                >
                                    {"Hi, I'm Asmita, an Applied AI Engineer specializing in LLM-driven system design, AI workflow orchestration, and intelligent automation.".split(" ").map((word, i) => (
                                        <motion.span
                                            ...
                                            className={i < 3 ? "font-bold text-white shadow-sm" : "hover:text-indigo-200 transition-colors"}
                                        >
                                            {word}
                                        </motion.span>
                                    ))}
                            ...
                            >
                                <motion.p
                                    className="text-slate-300 text-lg leading-relaxed flex flex-wrap gap-x-1.5"
                                    variants={{
                                        animate: { transition: { staggerChildren: 0.008, delayChildren: 0.4 } }
                                    }}
                                >
                                    {"Skilled in prompt optimization, model evaluation, API integration, real-time inference, and scalable deployment of AI systems. I architect end-to-end AI pipelines—from data ingestion through reasoning, post-processing, and production rollout—while ensuring reliability, interpretability, and maintainability.".split(" ").map((word, i) => (
                                        <motion.span
                                            key={i}
                                            variants={{
                                                initial: { y: 12, opacity: 0, filter: "blur(8px)" },
